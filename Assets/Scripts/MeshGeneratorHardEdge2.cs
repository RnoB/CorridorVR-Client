...
public class MeshGeneratorHardEdge2 : MonoBehaviour {
    ...
    void Start() {
        ...
        for (int k=0;k<pointLights.Length;k++)
        {
            ...
            else if (k%3==1)
            {
                ...
                pointLightsComp[k].intensity = .03f;  
            }
            else
            {
        ...
        float wa = Ltot / 4;
        j++;
        pointLights[j].transform.position = new Vector3(Wbi, W / 2, + Ltot / 2);
        j++;
        pointLights[j].transform.position = new Vector3(-Wbi, W / 2, + Ltot / 2);
        j++;
        ...
        j++;
        pointLights[j].transform.position = new Vector3(Wbi, W / 2, -3*Ltot / 2);
        j++;
        pointLights[j].transform.position = new Vector3(-Wbi, W / 2, -3*Ltot / 2);
